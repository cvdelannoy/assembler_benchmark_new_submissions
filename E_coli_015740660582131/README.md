  ...
  <div id="abstract" class="mqc-module-section">
    ...
    <h6>
        The MinION is a portable DNA sequencer that generates long error-prone reads.
         ...
         assemblers available to MinION users, on a read set of <i>E. coli</i>. This benchmark is based on a 
...
<div id="analysis_dirs_wrapper">
  <p>Report generated on 2018-04-04, 01:57 based on data in:
  <code class="mqc_analysis_path">/mnt/nexenta/lanno001/nobackup/int_ab_20180404/summarized_results</code>
...
<div id="general_stats" class="mqc-module-section">
  <h2>General Statistics</h2>
        ...
        <thead><tr><th class="rowheader">Sample Name</th><th id="header_mqc-generalstats-N50" class="mqc-generalstats-N50 " data-dmax="307.611" data-dmin="0.0" data-namespace="QUAST" ><span class="mqc_table_tooltip" title="QUAST: N50 is the contig length such that using longer or equal length contigs produces half (50%) of the bases of the assembly (kilo base pairs)">N50 (Kbp)</span></th><th id="header_mqc-generalstats-Total_length" class="mqc-generalstats-Total_length " data-dmax="2.506984" data-dmin="0.0" data-namespace="QUAST" ><span class="mqc_table_tooltip" title="QUAST: The total number of bases in the assembly (mega base pairs).">Length (Mbp)</span></th><th id="header_mqc-generalstats-CPU_time" class="mqc-generalstats-CPU_time " data-dmax="0" data-dmin="0" data-namespace="assembler benchmark CPU times" ><span class="mqc_table_tooltip" title="assembler benchmark CPU times: CPU time">CPU time</span></th></tr></thead><tbody><tr><th class="rowheader" data-original-sn="minimap2_miniasm">minimap2_miniasm</th><td class="data-coloured mqc-generalstats-N50 "><div class="wrapper"><span class="bar" style="width:100.0%; background-color:#b3d2c3;"></span><span class="val">307.6Kbp</span></div></td><td class="data-coloured mqc-generalstats-Total_length "><div class="wrapper"><span class="bar" style="width:100.0%; background-color:#b3c7bf;"></span><span class="val">2.5Mbp</span></div></td><td class="data-coloured mqc-generalstats-CPU_time "><div class="wrapper"><span class="bar" style="width:0%; background-color:#b5c6d9;"></span><span class="val">0:00:15</span></div></td></tr></tbody></table></div></div>
</div>
